    ...
    <>
      <AnimatePresence mode="wait">
        <Routes location={location} key={location.pathname}>
          <Route path='' element={<Landing landingAnimation={landingAnimation} setLandingAnimation={setLandingAnimation} showcaseAnimation={showcaseAnimation} setShowcaseAnimation={setShowcaseAnimation} aboutAnimation={aboutAnimation} setAboutAnimation={setAboutAnimation} contactAnimation={contactAnimation} setContactAnimation={setContactAnimation} filteredTags={filteredTags} setFilteredTags={setFilteredTags}/>} />
